...
(function () {
  ...
  Zotero.GoogleDocs.UI = {
    ...
    getSelectedFieldID: async function () {
      await this.clickElement(document.getElementById('insertLinkButton'));
      await Zotero.Promise.delay();
      let isApplyEnabled = !document.querySelector('.docs-link-insertlinkbubble .docs-link-insertlinkbubble-buttonbar .jfk-button').classList.contains('jfk-button-disabled');
